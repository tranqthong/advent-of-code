...
fn day_one_2024(l1: &mut Vec<i32>, l2: &mut Vec<i32>) -> i32 {
    l1.sort();
    l2.sort();
...
// cleaner solution
fn day_one_2024_no_sort(l1: &mut Vec<i32>, l2: &mut Vec<i32>) -> i32 {
...
mod tests {
    ...
    #[test]
    fn test_2024_day_one() {
        let mut l1 = vec![3, 4, 2, 1, 3, 3];
        let mut l2 = vec![4, 3, 5, 3, 9, 3];
        let expected_result = 11;

        let result = day_one_2024(&mut l1, &mut l2);

        assert_eq!(result, expected_result);
    }

    #[test]
    fn test_2024_day_one_a() {
        let mut l1 = vec![3, 4, 2, 1, 3, 3];
        let mut l2 = vec![4, 3, 5, 3, 9, 3];
        let expected_result = 11;

        let result = day_one_2024_no_sort(&mut l1, &mut l2);
